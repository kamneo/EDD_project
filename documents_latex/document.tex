...
une organisation bien précise pour qu'elle puisse être le plus possible
générique, c'est-\`a-dire qu'elle s'adapte aux évolutions du projet.
...
réalisé pendant près de trois ou quatre semaines fait un peu mal. Nous avons pris ces critiques en compte et en avons corrigé un
...
qui nous avait échappé. Hormis la factorisation de do\_move et can\_move tout
est a l'heure actuel corrigé. Nous n'avons malheureusement pas eu le temps de
reprendre l'implémentation de ces fonctions.
...
efficiente, nous allons à une profondeur de trois et nous prenons en compte
...
jamais réussie a dépasser les score de la première version que nous avions. Qui plus est nous avons été disqualifier
...
\newpage
\section{En bref}
Bien que passionnant, le projet fu très long mais très enrichissant. Nous
avons appris à travailler en groupe, utiliser des technologies nouvelles comme
GIT, SDL ou encore CMake. Le plus intéressant était de voir nous processus
de développement évoluer au fur et à mesure des TP et des cours en amphi.
On a notament utilisé " valgrind " pour les fuites mémoires, " gdb " pour tout
pour les débugage su code, " eclipse " et " sublime text " pour
tout ce qui est environement de développement.
...
de jeu ou les stratégies. Mais tout n'est pas parfait, dans le moteur du jeu
...
d'évaluation de grille ne sont pas optimales  et avec plus de temps nous
aurrions surement pu amélioré le programme. Et pour l'interface graphique
sous " SDL " et " NCurses ", nous avons réussit à éliminé
toutes les fuites mémoires.
\newpage
